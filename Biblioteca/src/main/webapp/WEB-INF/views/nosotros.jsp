	...
	<div class='h_btm'>
		<div class='cssmenu'>
			<ul>
			    ...
			    <li class='active'><a href='nosotros'><span>Nosotros</span></a></li>
...
<div class="main">
	<div class="About us">
		<div class="about-header">
			<h3>Biblioteca ITGAM</h3>
			<div class="clear"> </div>
			<div id="slider" class="nivoSlider">
	                <img src="resources/image/banner5.jpg" data-thumb="resources/image/5.jpg" alt="" />
	                <img src="resources/image/banner6.jpg" data-thumb="resources/image/6.jpg" alt="" />
	                <img src="resources/image/banner7.jpg" data-thumb="resources/image/7.jpg" alt="" />
	            </div>
		</div>
						<div class="about-info">
							<a href="#"><center>Quienes somos.</a>
							<p><center>La Biblioteca ITGAM está ubicada en la zona norte de la Ciudad de México, a un costado de la estación Villa de Aragon. Ofrece servicios educativos, informativos y culturales y pone a disposición del lector  y al los miembros de la Institución tanto como estudiantes y profesores, integrado por: libros, videos, revistas y periódicos, tanto para consulta en sala tanto como préstamo a domicilio. Todos los servicios son gratuitos excepto con una serie de requisitos para su dicha acción.</p>
							<br>
							<p><center>Cuenta con una área de consuta  y referencia. 20 Computadoras y equipos portátiles con acceso a Internet, una área de publicaciones periódicas.</p>
						</div>
					<div class="specials">
					...
					<div class="specials-grids">
						<div class="special-grid">
							<img src="resources/image/pic2.jpg" title="image-name">
						...
						<div class="special-grid">
							<img src="resources/image/pic3.jpg" title="image-name">
							<a href="#">Pre Plans</a>
							<p>Lorem ipsum dolor sit amet consectetur adiing elit. In volutpat luctus eros ac placerat. Quisque erat metus facilisis non feu,aliquam hendrerit quam. Donec ut lectus vel dolor adipiscing tincnt.</p>
						</div>
						<div class="special-grid spe-grid">
							<img src="resources/image/pic4.jpg" title="image-name">
							<a href="#">Free Plans</a>
							<p>Lorem ipsum dolor sit amet consectetur adiing elit. In volutpat luctus eros ac placerat. Quisque erat metus facilisis non feu,aliquam hendrerit quam. Donec ut lectus vel dolor adipiscing tincnt.</p>
						</div>
						<div class="clear"> </div>
